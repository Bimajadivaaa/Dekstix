      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          <div className="max-w-xl">
            <Badge variant="outline" className="mb-4 px-3 py-1 border-white/20 text-white/70 bg-white/10">
            ...
            <div className="space-y-4 mb-8">
              {[
                { icon: Shield, text: "Blockchain-enhanced security protocols" },
                { icon: RefreshCw, text: "Instant wallet-to-wallet ticket transfers" },
                { icon: Wallet, text: "Multi-chain crypto wallet compatibility" },
              ].map((item, index) => (
                <div key={index} className="flex items-start gap-3 bg-white/5 p-3 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
          ...
          <div className="relative">
            ...
            <Card className="relative overflow-hidden rounded-3xl border border-white/10 shadow-2xl bg-[#1a1a1a] p-1">
              <div className="relative p-6 flex flex-col items-center z-10">
                <div className="absolute top-0 right-0 bg-white/10 text-white text-xs px-3 py-1 rounded-bl-lg font-medium">
                  Blockchain Verified
                </div>
                ...
                <div className="w-full mt-4 space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-white/70">Smart Contract</span>
