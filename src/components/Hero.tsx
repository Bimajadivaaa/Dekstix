          ...
          <div className="space-y-8">
            <div className="space-y-5">
              ...
              <p className="text-xl text-white/70 max-w-2xl">
                Secure, transparent, and immutable blockchain ticketing
                solution. Own your tickets as collectible NFTs while ensuring
          ...
          <div className="relative">
            ...
            <Card className="relative w-full bg-[#1a1a1a] border border-white/10 shadow-2xl rounded-2xl overflow-hidden group">
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    <h3 className="text-xl font-bold text-white">
                      Museum Karaton Festival
                    </h3>
                    <p className="text-white/70">
                      Surakarta, Jawa Tengah • March 20, 2025
                    </p>
                  </div>
              ...
              <CardFooter className="p-6 pt-0 gap-2 border-t border-white/10">
                <Link
                  href="/Ticket/Ticket"
                  className="w-full rounded-xl gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 mt-5"
                >
                  <Button className="w-full rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/20">
                    <Sparkles className="h-4 w-4" />
                    <span className="font-mono text-xs">Mint Your Ticket</span>
                  </Button>
                </Link>
              </CardFooter>
            </Card>
      ...
      <div className="relative container mx-auto px-4 mt-8">
        <div className="flex flex-wrap justify-center gap-4">
          {[
            ...
            <div
              key={feature}
              className="px-4 py-2 bg-white/5 rounded-full border border-white/10 shadow-lg text-sm font-medium text-white/70 hover:bg-white/10 transition-colors"
            >
              {feature}
            </div>
          ))}
